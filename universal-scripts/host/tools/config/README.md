...
load_address = "0x48000000"
xspi_region_start = "000000"
xspi_region_size = "310000"
...
- **`xspi_region_start` / `xspi_region_size`** define the board-owned xSPI
  range shared by BootloaderFlash layout validation and the ULoad erase step.

...
${BOOT_VARS}
# Override SPI flash stale env — ensures fdt_ovrun loads DT overlays
mmc_do_boot=run mmc_args; run image_select; fatload mmc \${mmcdev}:\${mmcpart} \${image_addr} \${kernel_image}; run fdt_ovrun; booti \${image_addr} - \${dtb_addr}
fdt_ovrun=if run fdt_load; then fdt addr \${dtb_addr}; fdt resize 0x10000; if env exists enable_overlay_i2c \&\& test \${enable_overlay_i2c} = 1 -o \${enable_overlay_i2c} = yes; then echo Applying DT overlay: \${model_string}-\${revision_major}.\${revision_minor}-ext-i2c.dtbo; if fatload mmc \${mmcdev}:\${mmcpart} \${dtbo_addr} \${overlaydir}/\${model_string}-\${revision_major}.\${revision_minor}-ext-i2c.dtbo; then fdt addr \${dtb_addr}; fdt apply \${dtbo_addr}; else echo WARN: missing overlay; fi; fi; if env exists enable_overlay_spi \&\& test \${enable_overlay_spi} = 1 -o \${enable_overlay_spi} = yes; then echo Applying DT overlay: \${model_string}-\${revision_major}.\${revision_minor}-ext-spi.dtbo; if fatload mmc \${mmcdev}:\${mmcpart} \${dtbo_addr} \${overlaydir}/\${model_string}-\${revision_major}.\${revision_minor}-ext-spi.dtbo; then fdt addr \${dtb_addr}; fdt apply \${dtbo_addr}; else echo WARN: missing overlay; fi; fi; if env exists enable_overlay_can \&\& test \${enable_overlay_can} = 1 -o \${enable_overlay_can} = yes; then echo Applying DT overlay: \${model_string}-\${revision_major}.\${revision_minor}-can.dtbo; if fatload mmc \${mmcdev}:\${mmcpart} \${dtbo_addr} \${overlaydir}/\${model_string}-\${revision_major}.\${revision_minor}-can.dtbo; then fdt addr \${dtb_addr}; fdt apply \${dtbo_addr}; else echo WARN: missing overlay; fi; fi; if env exists enable_overlay_dsi \&\& test \${enable_overlay_dsi} = 1 -o \${enable_overlay_dsi} = yes; then echo Applying DT overlay: \${model_string}-\${revision_major}.\${revision_minor}-dsi.dtbo; if fatload mmc \${mmcdev}:\${mmcpart} \${dtbo_addr} \${overlaydir}/\${model_string}-\${revision_major}.\${revision_minor}-dsi.dtbo; then fdt addr \${dtb_addr}; fdt apply \${dtbo_addr}; else echo WARN: missing overlay; fi; fi; if env exists enable_overlay_audio_codec \&\& test \${enable_overlay_audio_codec} = 1 -o \${enable_overlay_audio_codec} = yes; then echo Applying DT overlay: \${model_string}-\${revision_major}.\${revision_minor}-audio-codec.dtbo; if fatload mmc \${mmcdev}:\${mmcpart} \${dtbo_addr} \${overlaydir}/\${model_string}-\${revision_major}.\${revision_minor}-audio-codec.dtbo; then fdt addr \${dtb_addr}; fdt apply \${dtbo_addr}; else echo WARN: missing overlay; fi; fi; if env exists enable_overlay_csi_ov5640 \&\& test \${enable_overlay_csi_ov5640} = 1 -o \${enable_overlay_csi_ov5640} = yes; then echo Applying DT overlay: \${model_string}-\${revision_major}.\${revision_minor}-ov5640.dtbo; if fatload mmc \${mmcdev}:\${mmcpart} \${dtbo_addr} \${overlaydir}/\${model_string}-\${revision_major}.\${revision_minor}-ov5640.dtbo; then fdt addr \${dtb_addr}; fdt apply \${dtbo_addr}; else echo WARN: missing overlay; fi; fi; if env exists enable_overlay_csi_ov5645 \&\& test \${enable_overlay_csi_ov5645} = 1 -o \${enable_overlay_csi_ov5645} = yes; then echo Applying DT overlay: \${model_string}-\${revision_major}.\${revision_minor}-cru-csi-ov5645.dtbo; if fatload mmc \${mmcdev}:\${mmcpart} \${dtbo_addr} \${overlaydir}/\${model_string}-\${revision_major}.\${revision_minor}-cru-csi-ov5645.dtbo; then fdt addr \${dtb_addr}; fdt apply \${dtbo_addr}; else echo WARN: missing overlay; fi; fi; if env exists fdt_extra_overlays \&\& test -n \${fdt_extra_overlays}; then for dtbo_file in \${fdt_extra_overlays}; do echo Applying DT overlay: \${dtbo_file}; if fatload mmc \${mmcdev}:\${mmcpart} \${dtbo_addr} \${overlaydir}/\${dtbo_file}; then fdt addr \${dtb_addr}; fdt apply \${dtbo_addr}; else echo WARN: missing overlay; fi; done; fi; else echo WARN: Cannot load base DT; fi
...
ExecStart=/bin/mkdir -p /data/home /data/var_lib /data/var_cache
...
ExecStart=/bin/sh -c '/usr/bin/test -z "$$(/bin/ls -A /data/var_cache 2>/dev/null)" && /bin/cp -a /var/cache/. /data/var_cache/ 2>/dev/null || true'
ExecStart=/bin/mount --bind /data/home /home
ExecStart=/bin/mount --bind /data/var_lib /var/lib
ExecStart=/bin/mount --bind /data/var_cache /var/cache
RemainAfterExit=yes
